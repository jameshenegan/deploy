clear
import delimited "../data-csv/cog_expces.csv", bindquote(strict)

label variable id_addi "Masked Participant ID for ADDI"

label variable visit ""

label variable cesd01 "I was bothered by things that usually do"

label variable cesd02 "I did not feel like eating; my appetite"

label variable cesd03 "I felt that I could not shake off the bl"

label variable cesd04 "I felt that I was just as good as other"

label variable cesd05 "I had trouble keeping my mind on what I"

label variable cesd06 "I felt depressed"

label variable cesd07 "I felt that everything I did was an effo"
